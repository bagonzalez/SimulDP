...
public class Matrix2DTransformation implements MatrixTransformation {
  ...
  public Matrix2DTransformation(double[][] matrix) {
    if (matrix!=null) internalTransform.setTransform(matrix[0][0], matrix[1][0], matrix[0][1],matrix[1][1], matrix[0][2],matrix[1][2]);
    update();
  }
  ...
  public AffineTransform getTotalTransform() { return totalTransform; }
