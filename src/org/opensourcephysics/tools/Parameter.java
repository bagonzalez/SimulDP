...
public class Parameter {
	...
	public boolean equals(Object obj) {
		if (obj instanceof Parameter) {
			...
			return p.getName().equals(paramName)
					&& p.getExpression().equals(expression)
					&& p.isExpressionEditable() == expressionEditable
					&& p.isNameEditable() == nameEditable;
		}
		return false;
	}
	...
	public double evaluate(Parameter[] parameters) {
		...
		try {
			MultiVarFunction f = new ParsedMultiVarFunction(expression, names);
