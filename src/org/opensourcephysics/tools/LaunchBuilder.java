...
public class LaunchBuilder extends Launcher {
  ...
  protected void refreshNode(LaunchNode node) {
    ...
    if(node!=null) {
      ...
      if((html==null)||(((html.path!=null)&&!html.path.equals(input))||((input!=null)&&!input.equals(html.path)))) {
        String title = (html==null)
                       ? null
                       : html.title;
      ...
      if((html!=null)&&(((html.title!=null)&&!html.title.equals(input))||((input!=null)&&!input.equals(html.title)))) {
  ...
  protected boolean saveChanges(LaunchPanel tab) {
    ...
    String name = (n>-1)
                  ? tabbedPane.getTitleAt(n)
                  : getDisplayName(root.getFileName());
  ...
  protected void refreshGUI() {
    ...
    if(node!=null) {
      ...
      LaunchNode.HTML html = node.getHTML(n);
      String urlPath = (html!=null)
                       ? html.path
                       : null;
      urlField.setText(urlPath);
      urlField.setBackground(((urlPath!=null)&&(html.url==null))
                             ? RED
                             : Color.white);
      ...
      htmlTabTitleField.setText((html!=null)
                                ? html.title
                                : null);
      ...
      jarField.setBackground(((node.classPath!=null)&&!getClassChooser().isLoaded(node.classPath))
                             ? RED
                             : Color.white);
      classField.setText(node.launchClassName);
      classField.setBackground(((node.getLaunchClass()==null)&&(node.launchClassName!=null))
                               ? RED
                               : Color.white);
      ...
      if(xmlArg) {
        ...
        argField.setBackground((res==null)
                               ? RED
                               : Color.white);
      } else {
  ...
  protected void createActions() {
    ...
    Icon openIcon = loadIcon(imageFile);
    ...
    keyListener = new KeyAdapter() {
      public void keyPressed(KeyEvent e) {
        ...
        if((e.getKeyCode()==KeyEvent.VK_ENTER)
          &&(((comp!=descriptionPane)&&(comp!=commentPane))||e.isControlDown()||e.isShiftDown())) {
          refreshSelectedNode();
          refreshGUI();
        } else {
