 ...
 */
  ...
  /**
   * Gets the ComplexDatasets. Implements Data.
   *
   * @return cloned list
   */
  ...
  protected void checkDatasetIndex(int datasetIndex) {
    while(datasetIndex>=datasets.size()) {
      Dataset d = new Dataset(DisplayColors.getMarkerColor(datasetIndex), DisplayColors.getLineColor(datasetIndex),
                              connected); // use specified colors
