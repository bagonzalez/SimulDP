...
public class DrawingPanel3D extends javax.swing.JPanel implements org.opensourcephysics.display.Renderable, org.opensourcephysics.display3d.core.DrawingPanel3D, Printable, ActionListener {
   ...
   private void BuildAxesPanel(int mode){
	  ...
	  if(axisMode==mode && xAxis!=null) return;
...
//            System.out.println("Key = "+keyPressed);
   ...
   public void setBackgroundImage(String _imageFile){ this.imageFile = _imageFile; }
   
   public String getBackgroundImage() { return this.imageFile; }
   ...
   public synchronized ArrayList<org.opensourcephysics.display3d.core.Element> getElements() {
   ...
   public int getAxesMode() { return axisMode; }
   ...
   private synchronized void paintEverything(Graphics g, int width, int height) {
      ...
      ArrayList<org.opensourcephysics.display3d.core.Element> tempList = getElements();
   ...
   private void paintDrawableList(Graphics g, ArrayList<org.opensourcephysics.display3d.core.Element> tempList) {
