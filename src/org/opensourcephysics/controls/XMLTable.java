    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
      ...
      if(column==0) { // property name
        ...
        if(OSPRuntime.translator!=null) {
          text = OSPRuntime.translator.getProperty(XMLTable.this, text);
        }
        setText(text);
      ...
      if(value instanceof XMLProperty) {                // object, array or collection type
        ...
        if((childClass!=OSPCombo.class                  // OSPCombo handled below
          ...
          setText(className);
          setBackground(isInspectable(parent)
                        ? lightGreen
                        : lightGray);
          //setBorder(BorderFactory.createEmptyBorder(2, 1, 2, 2));
    ...
    public boolean isCellEditable(EventObject e) {
      if(e instanceof MouseEvent) {
        ...
        if(value instanceof XMLControl) {
          ...
          if((childControl.getObjectClass()==OSPCombo.class)||(childControl.getObjectClass()==Boolean.class)
            ||(childControl.getObjectClass()==Character.class)) {
            return true;
          }
        }
