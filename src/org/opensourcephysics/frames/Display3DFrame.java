...
public class Display3DFrame extends DrawingFrame3D {
  ...
  * <ul>
  *   <li>Camera.MODE_PERSPECTIVE: 3D mode in which objects far away look smaller.</li>
  *   <li>Camera.MODE_NO_PERSPECTIVE: 3D mode in which distance doesn't affect the size
  *       of the objects</li>
